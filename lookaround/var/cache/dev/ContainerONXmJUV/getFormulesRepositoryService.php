 ...
 */
class getFormulesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FormulesRepository' shared autowired service.
     *
     * @return \App\Repository\FormulesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FormulesRepository.php';

        return $container->privates['App\\Repository\\FormulesRepository'] = new \App\Repository\FormulesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
