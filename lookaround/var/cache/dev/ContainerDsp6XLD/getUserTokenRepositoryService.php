 ...
 */
class getUserTokenRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserTokenRepository' shared autowired service.
     *
     * @return \App\Repository\UserTokenRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserTokenRepository.php';

        return $container->privates['App\\Repository\\UserTokenRepository'] = new \App\Repository\UserTokenRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
