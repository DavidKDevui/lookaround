...
return [
    ...
    [ // $staticRoutes
        ...
        '/getFacture' => [[['_route' => 'app_getFacture', '_controller' => 'App\\Controller\\ClientController::getFacture'], null, ['POST' => 0], null, false, false, null]],
        ...
        '/isPhotosExiste' => [[['_route' => 'app_isPhotosExiste', '_controller' => 'App\\Controller\\ClientController::isPhotosExiste'], null, ['POST' => 0], null, false, false, null]],
        '/rendezVousSoonMail' => [[['_route' => 'app_rendezVousSoonMail', '_controller' => 'App\\Controller\\ClientController::rendezVousSoonMail'], null, ['POST' => 0], null, false, false, null]],
        '/mot-de-passe-oublie' => [[['_route' => 'mot_de_passe_oublie', '_controller' => 'App\\Controller\\ClientController::motDePasseOublie'], null, null, null, false, false, null]],
        ...
        '/updateCreneau' => [[['_route' => 'app_updateCreneau', '_controller' => 'App\\Controller\\RegistrationController::updateCommande'], null, ['POST' => 0], null, false, false, null]],
        '/deleteCommande' => [[['_route' => 'app_deleteCommande', '_controller' => 'App\\Controller\\RegistrationController::deleteCommande'], null, ['POST' => 0], null, false, false, null]],
        '/getCreneauDispo' => [[['_route' => 'app_getCreneauxDispo', '_controller' => 'App\\Controller\\RegistrationController::getCreneauxDispo'], null, ['POST' => 0], null, false, false, null]],
        '/reprendreCommande' => [[['_route' => 'app_reprendreCommande', '_controller' => 'App\\Controller\\RegistrationController::reprendreCommande'], null, ['POST' => 0], null, false, false, null]],
        '/rembourserCommande' => [[['_route' => 'app_rembourserCommande', '_controller' => 'App\\Controller\\RegistrationController::rembourserCommande'], null, ['POST' => 0], null, false, false, null]],
