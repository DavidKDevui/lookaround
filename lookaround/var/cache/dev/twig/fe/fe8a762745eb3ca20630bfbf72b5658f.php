...
class __TwigTemplate_819333cef7202c63dc75dc05ed9173a6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <form method=\"post\" action=\"{{ path('envoyer_email') }}\">
        <label for=\"email\">Adresse e-mail :</label>
        <input type=\"email\" id=\"email\" name=\"email\" required>

        <button type=\"submit\">Réinitialiser le mot de passe</button>
    </form>
{% endblock %}", "reset_password/request.html.twig", "C:\\Users\\utils\\Documents\\lookaround\\Website\\lookaround\\templates\\reset_password\\request.html.twig");
    }
}
