...
class __TwigTemplate_41b1dd4e45ee93f382e5b8a862df403f extends \Twig\Template
{
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo " Politique de confidentialité - Réalisation de visites immersives à 360° ";
...
<section class='Body-Section-White'>
    ...
    <ul style=\"margin-top: 8px; font-size: 14px;text-align: left; padding: 0px 75px; font-weight: 300\">
        ...
        <li class=\"li-text\">Marketing : si vous avez donné votre consentement, nous utilisons vos données personnelles pour vous envoyer des newsletters et des offres promotionnelles.</li>
    ...
    <h3 style=\"margin-top: 30px; font-size: 15px;text-align: left; padding: 0px 55px;\">4. Consentement</h3>
    <p style=\"text-align: left\">En utilisant notre site web, vous acceptez que nous collections, traitions et utilisions vos données personnelles conformément à cette politique de confidentialité. Vous avez le droit de retirer votre consentement à tout moment en nous contactant <a href='";
        // line 76
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_index_scroll");
        echo "'>ici</a>.</p>

    <h3 style=\"margin-top: 30px; font-size: 15px;text-align: left; padding: 0px 55px;\">5. Durée de conservation des données</h3>
    ...
    <h3 style=\"margin-top: 30px; font-size: 15px;text-align: left; padding: 0px 55px;\">6. Sécurité des données</h3>
    ...
    <h3 style=\"margin-top: 30px; font-size: 15px;text-align: left; padding: 0px 55px;\">7. Partage des données</h3>
    ...
    <h3 style=\"margin-top: 30px; font-size: 15px;text-align: left; padding: 0px 55px;\">8. Droits des personnes concernées</h3>
    ...
    <h3 style=\"margin-top: 30px; font-size: 15px;text-align: left; padding: 0px 55px;\">9. Modification de la politique de confidentialité</h3>
    <p style=\"text-align: left\">Nous nous réservons le droit de modifier cette politique de confidentialité à tout moment. Nous vous recommandons de consulter régulièrement cette politique pour être informé des éventuelles modifications.</p>

    <h3 style=\"margin-top: 30px; font-size: 15px;text-align: left; padding: 0px 55px;\">10. Contact</h3>
    ...
    ";
        // line 100
        $this->loadTemplate("tools/footer.html.twig", "politiqueconfidentialite.html.twig", 100)->display($context);
        // line 101
        echo "</section>
...
";
    ...
    {
        return array (  251 => 101,  249 => 100,  240 => 94,  231 => 88,  216 => 76,  186 => 48,  184 => 47,  172 => 37,  159 => 30,  156 => 29,  152 => 28,  148 => 26,  135 => 19,  132 => 18,  128 => 17,  122 => 14,  119 => 13,  109 => 12,  96 => 8,  92 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block title %} Politique de confidentialité - Réalisation de visites immersives à 360° {% endblock %}
...
<section class='Body-Section-White'>
    ...
    <h3 style=\"margin-top: 30px; font-size: 15px;text-align: left; padding: 0px 55px;\">4. Consentement</h3>
    <p style=\"text-align: left\">En utilisant notre site web, vous acceptez que nous collections, traitions et utilisions vos données personnelles conformément à cette politique de confidentialité. Vous avez le droit de retirer votre consentement à tout moment en nous contactant <a href='{{ path('app_index_scroll')}}'>ici</a>.</p>
